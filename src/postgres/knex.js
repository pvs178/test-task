 ...
 * @param {[number, string[]]} result - Migration result
 */
function logMigrationResults(action, result) {
...
/**
 * Log migration list
 * @param {[Array<{name: string}>, Array<{file: string}>]} list - Migration list
 */
function logMigrationList(list) {
...
/**
 * Log seed run results
 * @param {[string[]]} result - Seed result
 */
function logSeedRun(result) {
...
/**
 * Log seed make result
 * @param {string} name - Seed name
 */
function logSeedMake(name) {
